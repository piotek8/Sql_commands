...
/* 1) Za³¹czanie rekordów do tabeli: TOWAR */
...
/* AKTUALIZACJA - Ulica musi zostaæ podana w danych ze wzglêdu na póŸniejszy zakup.
Za³¹czam w typie danych NOT NULL, ¿eby w tym miejscu klient wpisa³ niezbêdne informacje. */
ALTER TABLE Client ALTER COLUMN Street VARCHAR(40) NOT NULL
 
/* 2) Za³¹czanie rekordów do tabeli: KLIENT */
...
-------------------------------
 ...
 Próba stworzenia klucza obcego w celu stworzenia relacji pomiêdzy tabelami, a w nich wystêpuj¹cymi kolumnami.
 Finalnie relacje stworzy³em manualnie w SSMS.
...
/* 3) Za³¹czanie rekordów do tabeli: ZAMOWIENIA */
...
/* 4) Za³¹czanie rekordów do tabeli: USLUGA */
...
/*  5) Za³¹czanie rekordów do tabeli: PRACOWNIK */
...
/* 6) Za³¹czanie rekordów do tabeli: KURS */
